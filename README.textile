h1. Albumdy is an open source photo gallery built with Ruby on Rails and jQuery using some of my favorite plugins and practices.

h2. A live demo is available at "albumdy.com":http://albumdy.com

h2. There are many existing photo gallery apps around, but none I could find demonstrating the following key technologies:
...
h2. You will need the following additional gems installed:
